...
const socials = [
  ...
  {
    label: "Facebook",
    href: "https://facebook.com/northbrook",
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-cream/60 text-sm leading-relaxed max-w-xs">
              Family-run knitwear brand crafting premium comfort pieces since 2018. Where quality meets conscience.
            </p>
            <div className="flex gap-3 mt-6">
              {socials.map((s) => (
                <a
                  ...
                  aria-label={s.label}
                  className="w-10 h-10 rounded-full border border-cream/20 flex items-center justify-center hover:bg-rust hover:border-rust transition-all duration-300"
                >
