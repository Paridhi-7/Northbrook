  ...
  return (
    <>
      <section className="relative min-h-[40vh] flex items-center justify-center overflow-hidden bg-charcoal">
        <img src="/products/cargo-boys/02.jpg" alt="Men's Collection" className="absolute inset-0 w-full h-full object-cover opacity-40" />
        ...
        <div className="relative z-10 text-center px-5">
          ...
          <motion.h1 initial={{ opacity: 0, y: 25 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="font-heading text-5xl sm:text-6xl text-white font-bold">Refined Knitwear</motion.h1>
        </div>
      </section>
