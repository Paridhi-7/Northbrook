  ...
  return (
    <>
      <section className="relative min-h-[40vh] flex items-center justify-center overflow-hidden bg-charcoal">
        <img src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=1920&h=600&fit=crop" alt="" className="absolute inset-0 w-full h-full object-cover opacity-40" />
